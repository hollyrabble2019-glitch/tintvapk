...
object UpdateManager {
    ...
    class UpdateConfig(
        ...
        val message: String = "يتوفر إصدار جديد من Tinghir TV. يرجى تحديث التطبيق للاستفادة من أحدث التحسينات.",
    ...
    private fun parseConfig(jsonStr: String): UpdateConfig? {
        return try {
            ...
            val updateObj = root.getJSONObject("update")
            UpdateConfig(
                enabled = updateObj.optBoolean("enabled", false),
